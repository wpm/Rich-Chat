...
// a user, the theme switch, dragging the text box taller, the Width
// slider widening every user's wrapped bubbles at once up to the
// transcript's edges, and that all of
